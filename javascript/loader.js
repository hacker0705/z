// window.onload = function () {
    ...
    document.getElementById("lprice").innerText = `${mintInfo.price.toFixed(mintInfo.toFixed)}`;
    // document.getElementById("ldate").innerText = `You will be able to see your NFT at the OpenSea`;
    ...
    document.getElementById("price").innerText = `${(mintInfo.price * mintInfo.minUnits).toFixed(mintInfo.toFixed)}`
